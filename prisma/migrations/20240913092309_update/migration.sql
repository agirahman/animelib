/*
  ...
  - Added the required column `anime_mal_id` to the `Comment` table without a default value. This is not possible if the table is not empty.
...
*/
-- AlterTable
ALTER TABLE `comment` ADD COLUMN `anime_mal_id` VARCHAR(191) NOT NULL,
